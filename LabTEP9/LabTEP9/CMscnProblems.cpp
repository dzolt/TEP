...
{	
	...
	ct_sellers_capacity_ammount.bSetSize(iNewCount);
	ct_sellers_income_value.bSetSize(iNewCount);
...
{	
	return cm_delivery_matrix.bSet(dValue, iSizeX, iSizeY);
}//bool CMscnProblem::bSetDeliveryMatrixVal(double dValue, int iSizeX, int iSizeY)

bool CMscnProblem::bSetFactoryMatrixVal(double dValue, int iSizeX, int iSizeY)
{	
	return cm_factory_matrix.bSet(dValue, iSizeX, iSizeY);
}//bool CMscnProblem::bSetFactoryMatrixVal(double dValue, int iSizeX, int iSizeY)

bool CMscnProblem::bSetWarehouseMatrixVal(double dValue, int iSizeX, int iSizeY)
{
	return cm_warehouse_matrix.bSet(dValue, iSizeX, iSizeY);
}//bool CMscnProblem::bSetWarehouseMatrixVal(double dValue, int iSizeX, int iSizeY)
