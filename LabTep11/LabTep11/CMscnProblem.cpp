...
double CMscnProblem::dGetMinValueAt(int iIndex)
{
	int iSize = i_suppliers_count * i_factories_count + i_factories_count * i_warehouses_count + i_warehouses_count * i_sellers_count;
...
double CMscnProblem::dGetMaxValueAt(int iIndex)
{
	int iSize = i_suppliers_count * i_factories_count + i_factories_count * i_warehouses_count + i_warehouses_count * i_sellers_count;
	if (iIndex < 0 || iIndex >= iSize) return -1;
