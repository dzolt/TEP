...
public:
	...
	CMatrix* pmGetMinItemsSupplierMatrix() { return cm_min_items_sent_from_supplier; };
	CMatrix* pmGetMaxItemsSupplierMatrix() { return cm_max_items_sent_from_supplier; };

	CMatrix* pmGetMinItemsFactoryMatrix() { return cm_min_items_sent_from_factory; };
	CMatrix* pmGetMaxItemsFactoryMatrix() { return cm_max_items_sent_from_factory; };

	CMatrix* pmGetMinItemsWarehouseMatrix() { return cm_min_items_sent_from_warehouse; };
	CMatrix* pmGetMaxItemsWarehouseMatrix() { return cm_max_items_sent_from_warehouse; };
	...
	double dGetMinValueAt(int iIndex);
	double dGetMaxValueAt(int iIndex);
